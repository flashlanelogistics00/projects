...
import { deleteShipment } from '@/app/dashboard/shipments/actions'
...
export function DeleteShipmentButton({ shipmentId }: { shipmentId: string }) {
    ...
    return (
        <button
            ...
            className="inline-flex items-center gap-2 px-4 py-2 bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400 font-semibold rounded-xl hover:bg-red-100 dark:hover:bg-red-900/40 transition-colors"
        >
